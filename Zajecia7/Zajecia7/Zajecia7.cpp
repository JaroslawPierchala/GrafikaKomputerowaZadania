...
void Display()
{
	...
	GLTVector3 vCorners[7] = { { 0.0f, 0.0f, -1.7f }, // Góra 0 ---> ty³
	{ -1.032f, 0.6, 1.0f }, // Lewy ty³ 1
	{ -1.032f, -0.6, 1.0f }, // Prawy ty³ 2
	{ 0.0f, 1.2f, 1.0f }, // Lewy srodek 3
	{ 0.0f, -1.2f, 1.0f  }, // Prawy srodek 4
	{ 1.032f, 0.6f, 1.0f  },  // Lewy przód 5
	{ 1.032f, -0.6f , 1.0f } }; // Prawy przód 6
